class Mutations::CreatePortfolioSecurity < Mutations::BaseMutation
  ...
  def resolve(portfolio_id:, security_id:)
    ...
    portfolio_security = PortfolioSecurity.new(portfolio: portfolio, security: security)

    if portfolio_security.save
      {
        portfolio: portfolio,
        security: security,
        errors: [],
